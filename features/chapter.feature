Feature: works can have one or more chapters
  ...
  Scenario: multi chaptered work
    ...
    When I am logged in
      ...
      And I press "Submit"
    Then I should see "Work successfully created"
    When I fill in "Content" with "The next day"
      And I fill in "Chapter name" with "Day 2"
    And I press "Submit"
    Then I should see "Great American Novel updated"
    When I fill in "Content" with "The day after that"
      And I fill in "Chapter name" with "Day 3"
